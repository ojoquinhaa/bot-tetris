...
class WebsocketClient(object):
    ...
    def __init__(self, api):
        ...
        """
        self.api = api
        self.headers = {"User-Agent": self.api.user_agent if not None else user_agent_list[random.randint(0, len(user_agent_list) - 1)],}
        ...
        try:
            ...
            try:
                ...
                if "call" in str(message) or 'put' in str(message):
                    ...
                    # get_candles(asset, offset, period)
                    #print(message)
